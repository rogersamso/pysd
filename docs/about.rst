...
- `Roger Samsó <https://github.com/rogersamso>`_ included a parser for the Vensim sketch and added the option to split a Vensim model per view based on the sketch information, and later developed the standalone Julia builder (ODE and MTK backends) together with `Claude Code <https://claude.ai/code>`_.
